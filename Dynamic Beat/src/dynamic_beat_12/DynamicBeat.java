...
public class DynamicBeat extends JFrame {
	...
	// 게임 생성자 부분을 제거하여 게임을 선언할 수만 있도록 변경 
	...
	public DynamicBeat() {
		...
		*/
		trackList.add(new Track("music1.png", "StartImage1.jpg",
				"GameImage1.jpg", "Future cut.mp3", "Future Glider - Brian Bolger.mp3", "Future Glider - Brian Bolger"));
		trackList.add(new Track("music2.png", "StartImage2.jpg",
				"GameImage2.jpg", "Snowy cut.mp3", "Snowy Peaks pt I - Chris Haugen.mp3", "Snowy Peaks pt I - Chris Haugen"));
		trackList.add(new Track("music3.png", "StartImage3.jpg",
				"GameImage3.jpg", "Straight cut.mp3", "Straight Fuse - French Fuse.mp3", "Straight Fuse - French Fuse"));
	...
	public void backMain() {
		...
		selectTrack(nowSelected);
		isGameScreen = false;
		// 게임과 음악을 종료하여 다른 곡을 선택할 수 있도록 하는 코드 
		game.close();
	}
